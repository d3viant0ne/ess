...
export default function routes($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('test', {
        url: '/test',
        template: `hello this is the test component`,
        controller: () => console.log('this is a test')
    });

    $stateProvider.state('anotherTest', {
        url: '/anotherTest',
        controllerAs: 'vm',
        controller: require('./components/test'),
        template: `hello this is the other test component {{ vm.data }}`,
